...
\begin{inlinelist}
    ...
    \item policy types
\end{inlinelist}.
Figure 1%~\ref{fig:mapping}
provides an overview of this mapping for all DPV taxonomies.

% \begin{figure}
%   \centering
%   \includegraphics[width=.5\linewidth]{overview.pdf}
%   \caption{}
%   \label{fig:mapping}
% \end{figure}
...
This mapping enables ODRL policies to explicitly represent legally relevant processing activities such as anonymisation or data transfer, which are frequently regulated by data protection legislation.
...
\begin{table}[ht]
\centering
\caption{Mapping of Processing Operations}
\begin{tabular}{lll}
\toprule
