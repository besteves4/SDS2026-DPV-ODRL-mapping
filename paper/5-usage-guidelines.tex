...
at \url{https://w3id.org/dpv/guides/dpv-odrl}
...
In the long term,
these examples will be integrated and maintained by the W3C's DPVCG
in its `Examples' report
available at \url{https://w3id.org/dpv/examples}.
