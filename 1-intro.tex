...
Section~\ref{sec:background} describes overview of existing work for data protection-aligned policy modelling.
Section~\ref{sec:mapping} provides ...
% In Section~\ref{sec:policies}, we define a specification for ...
In Section~\ref{sec:guidelines}, we define a specification for ...
